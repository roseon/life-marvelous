...
private:
	...
	bool					m_bEnableCwDisplay;
	bool					m_bEnableDamageLog;
	bool					m_bEnableEsp;
...
public:
	...
	bool GetDisplay()					{ return m_bEnableDisplay; }
	void SetDisplay(bool bVal)			{ m_bEnableDisplay = bVal; }
	bool GetCwDisplay()					{ return m_bEnableCwDisplay; }
	void SetCwDisplay(bool bVal)		{ m_bEnableCwDisplay = bVal; }
	bool GetDamageLog()					{ return m_bEnableDamageLog; }
	void SetDamageLog(bool bVal)		{ m_bEnableDamageLog = bVal; }
	bool GetEsp()						{ return m_bEnableEsp; }
	void SetEsp(bool bVal)				{ m_bEnableEsp = bVal; }
	bool GetAimfix()					{ return m_bEnableAimfix; }
	void SetAimfix(bool bVal)			{ m_bEnableAimfix = bVal; }
	vector<string>& GetIgnoreList()		{ return m_IgnoredUsers; }
