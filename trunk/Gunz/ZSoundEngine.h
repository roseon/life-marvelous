...
protected:
	...
	char m_szCustomMusicNames[60][64];
	bool m_bMusicEnded;
...
public:
	...
	bool Reload();
	bool HasMusicStopped(); //PenguinGuy
	...
	bool OpenCustomMusicFileByRand();
...
#define VOICE_COOL					"NAR01"		// 0.7  추가 완료
#define VOICE_NICE					"NAR02"		// 1.0  추가 완료
#define VOICE_GREAT					"NAR03"		// 0.8  추가 완료
#define VOICE_WONDERFUL				"NAR04"		// 1.2  추가 완료
#define VOICE_KILLEDALL				"NAR05"		// 2.0  추가 완료
#define VOICE_HEADSHOT				"NAR06"		// 0.7  추가 완료
#define VOICE_FANTASTIC				"NAR07"		// 1.5  추가 완료
#define VOICE_EXCELLENT				"NAR08"		// 1.0  추가 완료
#define VOICE_UNBELIEVABLE			"NAR09"		// 1.3  추가 완료
#define VOICE_GET_READY				"NAR10"		// 1.3  추가 완료
#define VOICE_LETS_ROCK				"NAR11"		// 1.1  추가 완료
#define VOICE_FINAL_ROUND			"NAR27"		// 1.2  추가 완료
#define VOICE_YOU_WON				"NAR12"		// 1.0  추가 완료
#define VOICE_YOU_LOSE				"NAR13"		// 1.3  추가 완료
#define VOICE_RED_TEAM_WON			"NAR14"		// 1.4  추가 완료
#define VOICE_BLUE_TEAM_WON			"NAR15"		// 1.4  추가 완료
#define VOICE_DRAW_GAME				"NAR16"		// 1.2  추가 완료
#define VOICE_REDTEAM_BOSS_DOWN		"NAR19"		// 2.0  추가 완료
#define VOICE_BLUETEAM_BOSS_DOWN	"NAR20"		// 2.1  추가 완료
#define VOICE_PLAYER_NOT_READY		"NAR26"		// 1.5  추가 완료
