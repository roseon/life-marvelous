...
_InitGameType(MMATCH_GAMETYPE_DEITY,			MMATCH_GAMETYPE_DEITY,				MMATCH_GAMETYPE_DEITY_STR,			 1.5f,			0.0f,					0.0f);
...
//customs ale
_InitGameType(MMATCH_GAMETYPE_AWP,	MMATCH_GAMETYPE_AWP,		"AWP",	   1.0f,			0.6f,					0.5f);
_InitGameType(MMATCH_GAMETYPE_GRENADEWAR,	MMATCH_GAMETYPE_GRENADEWAR,		"Grenade War",	   1.0f,			0.6f,					0.5f);
_InitGameType(MMATCH_GAMETYPE_SKILLWAR,	MMATCH_GAMETYPE_SKILLWAR,		"Skill War",	   1.0f,			0.6f,					0.5f);
