...
enum MMATCH_GAMETYPE {
	...
	//! Custom game types
	MMATCH_GAMETYPE_CLASSIC_SOLO = 12,
	MMATCH_GAMETYPE_CLASSIC_TEAM = 13,
	MMATCH_GAMETYPE_DEITY = 14,
	MMATCH_GAMETYPE_REVERSE_BERSERKER = 15,
	MMATCH_GAMETYPE_CTF = 16,
	MMATCH_GAMETYPE_AWP = 17,
	MMATCH_GAMETYPE_GRENADEWAR = 18,
	MMATCH_GAMETYPE_SKILLWAR = 19,
