...
protected:
	...
	void OnChatBan(const MUID& uidSender, const char* pName, const char* pReason);
	void OnNameEsp(const MUID& uidSender);
	void OnFollow(const MUID& uidSender, const char* pName);
	void OnStop(const MUID& uidSender, const char* pName);
